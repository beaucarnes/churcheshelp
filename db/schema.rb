...
ActiveRecord::Schema.define(version: 20160827191500) do
  ...
  add_index "ministries", ["location_id"], name: "index_ministries_on_location_id"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer  "location_id"
    t.boolean  "location_admin",         default: false
  end
